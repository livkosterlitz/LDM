...
from SimFunctionsStochasticParams import *

#troubleshooting 
#from SimFunctionsStochasticParams import *
# SimRun_path = "SimRun.py"
# input_CSV = "/Users/oliviakosterlitz/Dropbox/Pop3/Simulations/Submission/Treatments/Treatments_variation.csv"           
...
for i in range(len(df['Treatment_ID'])):
    ...
    for e in range(df['Num_of_experiments'][i]):
        ...
        for p in range(df['Num_sims_I1'][i]):
            ...
            shell_line_variation (SimRun_path, df, f, i, e, incubation, p)
        ...
        for t in range(df['Num_sims_I2'][i]):
            ...
            shell_line_variation (SimRun_path, df, f, i, e, incubation, t)
